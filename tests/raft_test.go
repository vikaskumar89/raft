...
func TestReElection2A(t *testing.T) {
	println("Executing TestReElection2A test")
	servers := 3
	cfg := make_config(t, servers, false, false)
	defer cfg.cleanup()
...
func TestManyElections2A(t *testing.T) {
	//println("Executing TestManyElections2A test")
	servers := 7
	cfg := make_config(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (2A): multiple elections")
	//go printRaftStats(cfg)
	cfg.checkOneLeader()
	iters := 10
...
func TestFailNoAgree2B(t *testing.T) {
	...
	///fmt.Println("Checking the leader")
	leader := cfg.checkOneLeader()
	//fmt.Printf("The current leader is %d\n", leader)
	//println("Disconnecting 3 servers")
	cfg.disconnect((leader + 1) % servers)
	...
	//fmt.Printf(" %d service thinks entry is committed\n", n)
	if n > 0 {
		t.Fatalf("%v committed but no majority", n)
	}

	// repair
	//println("Connecting servers again")
	cfg.connect((leader + 1) % servers)
...
func TestRejoin2B(t *testing.T) {
	...
	cfg.one(103, 2, true)
	//fmt.Printf("The new entry is committed at index %d\n", idx)

	// new leader network failure
	leader2 := cfg.checkOneLeader()
	//fmt.Printf("Disconnecting the new leader %d\n", leader2)
	cfg.disconnect(leader2)

	// old leader connected again
	//fmt.Printf("Older leader connecting again %d\n", leader1)
	cfg.connect(leader1)
...
func TestPersist12C(t *testing.T) {
	...
	//fmt.Printf("1st Log is commited at index %d\n", idx)
	...
	//fmt.Printf("2nd Log is commited at index %d\n", idx)
	leader1 := cfg.checkOneLeader()
	//fmt.Println("Leader 1 is ", leader1)
	cfg.disconnect(leader1)
	cfg.start1(leader1, cfg.applier)
	cfg.connect(leader1)

	cfg.one(13, servers, true)
	//fmt.Printf("3rd Log is commited at index %d\n", idx)

	leader2 := cfg.checkOneLeader()
	//fmt.Println("Leader 2 is ", leader2)
	cfg.disconnect(leader2)
	cfg.one(14, servers-1, true)
	//fmt.Printf("4th Log is commited at index %d\n", idx)
	...
	//fmt.Printf("5th Log is commited at index %d\n", idx)
	cfg.start1(i3, cfg.applier)
	cfg.connect(i3)

	cfg.one(16, servers, true)
	//fmt.Printf("6th Log is commited at index %d\n", idx)
...
func TestPersist22C(t *testing.T) {
	...
	for iters := 0; iters < 5; iters++ {
		...
		//fmt.Printf("Iteration %d 1st Log is appended at index %d\n", iters, idx)
		index++
		...
		//fmt.Printf("Iteration %d 2nd Log is appended at index %d\n", iters, idx)
		index++
		...
		cfg.connect((leader1 + 1) % servers)
		cfg.connect((leader1 + 2) % servers)
		//fmt.Printf("Before Time out in iteration %d\n", iters)
		time.Sleep(RaftElectionTimeout)
		//fmt.Printf("After Time out in iteration %d\n", iters)
		cfg.start1((leader1+3)%servers, cfg.applier)
		cfg.connect((leader1 + 3) % servers)

		cfg.one(10+index, servers-2, true)
		//fmt.Printf("Iteration %d 3rd Log is commited at index %d\n", iters, idx)
		index++
